...
import { useChatSDK } from '@/components/providers/chat-provider-sdk';

export function ChatAppSDK() {
  ...
  return (
    <div className="h-full flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="chat-container flex-1 max-w-5xl p-8 flex flex-col gap-8 justify-between">
          <ChatHeader
            theme={theme}
            effectiveTheme={effectiveTheme}
            onThemeChange={setTheme}
            onResetConversation={handleNewThread}
          />
